...
int deadZoneY = 500;  // normal for Y
    ...
    case CONNECTED:
      {
        ...
        if (millis() - lastSend >= SEND_INTERVAL_MS) {
          ...
          // Measure your joystick neutral positions first (print them in setup)
          const int centerLX = 2680;  // Left joystick X center
          const int centerLY = 2620;  // Left joystick Y center (not used here)
          const int centerRX = 2930;  // Right joystick X center (not used here)
          const int centerRY = 3040;  // Right joystick Y center
